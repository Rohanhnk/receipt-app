    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-20 md:py-28 bg-gradient-to-b from-blue-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <div className="mt-12 flex justify-center">
          <div className="relative w-full max-w-3xl rounded-lg border border-gray-200 bg-white shadow-lg overflow-hidden dark:border-gray-800 md:p-8">
      ...
      {/* Pricing */}
      <section className="pyp-16 md:py-24 bg-gray dark:bg-gray-900">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">
              ...
              <p className="max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                Choose the plan that works the best for your needs.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 max-w-5xl mx-auto">
            {/* Free Tier */}
            <div className="flex free-col p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-800 dark:bg-gray-950">
              <div className="space-y-2">
              ...
              <ul className="mt-6 space-y-2 flex-1">
                <li className="flex items-center">
                  <Check className="text-green-500 h-5 w-5 me-2" />
                  <span>2 cans per month</span>
                </li>
            ...
            {/* Pro Tier */}
            <div className="flex free-col p-6 bg-blue-50 border border-blue-200 rounded-lg shadow-sm dark:border-blue-900 dark:bg-blue-900/20">
              <div className="absolute top-3 right-4 bg-blue-600 text-white px-3 py-1 rounded-bl-lg text-sm font-medium">
                Most Popular
              </div>
              <div className="space-y-2">
                <h3 className="text-2xl font-bold">Pro</h3>
                <p className="text-gray-500 dark:text-gray-400">
                  Pro feature for pro users!
                </p>
              </div>
              <div className="mt-4">
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-fray-500 md:text-xl dark:text-gray-400">
                Join thousand of users who save time and gain insights from
                their receipts
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0">
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Expensio. Teh snarter way to track your money
              </p>
            </div>
          </div>
        </div>
